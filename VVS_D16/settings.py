"""
Django settings for Board_D16 project.
...
INSTALLED_APPS = [
    ...
    # https://www.youtube.com/watch?v=Rh7THG1-THU - см настройку здесь или
    # https://www.youtube.com/watch?v=fMZBTCRGMS8&ab_channel=DjangoSchool
    'ckeditor',
    'ckeditor_uploader',
    ...
    # Для отправки периодических задач
    'django_apscheduler',
